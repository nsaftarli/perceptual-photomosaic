...
class VGG16:
	...
	def build_vgg(self, input, trainable):
		...
		#################Block 1################
		self.conv1_1 = self.conv_layer(self.vgg_input, name='conv1_1', trainable=False)
		self.conv1_2 = self.conv_layer(self.conv1_1, name='conv1_2', trainable=False)
		self.pool1 = tf.nn.max_pool(self.conv1_2, ksize=[1,2,2,1], strides=[1,2,2,1], padding='SAME', name='pool1')
		#################Block 2################
		self.conv2_1 = self.conv_layer(self.pool1, name='conv2_1', trainable=False)
		self.conv2_2 = self.conv_layer(self.conv2_1, name='conv2_2', trainable=False)
		self.pool2 = tf.nn.max_pool(self.conv2_2, ksize=[1,2,2,1], strides=[1,2,2,1], padding='SAME', name='pool2')
		#################Block 3################
		self.conv3_1 = self.conv_layer(self.pool2, name='conv3_1', trainable=False)
		self.conv3_2 = self.conv_layer(self.conv3_1, name='conv3_2', trainable=False)
		self.conv3_3 = self.conv_layer(self.conv3_2, name='conv3_3', trainable=False)
		self.pool3 = tf.nn.max_pool(self.conv3_3, ksize=[1,2,2,1], strides=[1,2,2,1], padding='SAME', name='pool3')
		#################Block 4################
		self.conv4_1 = self.conv_layer(self.pool3, name='conv4_1', trainable=False)
		self.conv4_2 = self.conv_layer(self.conv4_1, name='conv4_2', trainable=False)
		self.conv4_3 = self.conv_layer(self.conv4_2, name='conv4_3', trainable=False)
		self.pool4 = tf.nn.max_pool(self.conv4_3, ksize=[1,2,2,1], strides=[1,2,2,1], padding='SAME', name='pool4')
		#################Block 5################
		self.conv5_1 = self.conv_layer(self.pool4, name='conv5_1', trainable=False)
